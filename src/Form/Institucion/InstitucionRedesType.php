...
class InstitucionRedesType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
            ->add('nombreRed', TextType::class, [
                'label' => 'Nombre de la red',
                'constraints' => [
                    new NotBlank([], 'Este valor no debe estar en blanco.')
                ]
            ])
            ->add('descripcionRed', TextType::class, [
                'label' => 'Descripción',
                'required' => false,
            ])
            ->add('RolRedes', EntityType::class, [
                'label' => 'Rol',
                'class' => RolRedesNacional::class,
                'choice_label' => 'nombre',
    ...
    public function configureOptions(OptionsResolver $resolver): void
    {
        $resolver->setDefaults([
            'data_class' => InstitucionRedes::class,
        ]);
    }
}
