                            ...
                            <fo:table-row font-size="8pt" text-transform="uppercase">
                                <fo:table-cell text-align="center">
                                    <fo:block margin-left="0.3em" margin-right="0.3em">
                                        <fo:external-graphic src="file:../../xsl/images/xabal.png" clear="none" float="left" content-height="0.4in" scaling="uniform" border="0" padding="0" margin="0" alignment-baseline="middle"/>
                                    </fo:block>
                                </fo:table-cell>
                            ...
                            <fo:table-row>
                                <fo:table-cell>
                                    <fo:block font-size="8pt" margin-left="0.3em" margin-right="0.3em">
                                        <fo:external-graphic src="file:../../xsl/images/setac.png" clear="none" float="left" content-height="0.35in" scaling="uniform" border="0" padding="0" margin="0" alignment-baseline="middle"/>
                            ...
                            <fo:table-row font-size="11pt" font-weight="bold" height="20px" line-height="20px"  border-top-width="1px" border-top-color="#a0a0a0">
                                ...
                                <fo:table-cell number-columns-spanned="{$spanned_col}">                        
                                    <fo:block margin-left="3px">
                                        <xsl:value-of select="header/table_title"></xsl:value-of>
                                    </fo:block>
                                </fo:table-cell>
                            </fo:table-row>
