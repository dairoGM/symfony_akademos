...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format">
    ...
    <xsl:template name="content_body">
            ...
            <fo:table margin-top="2em" table-omit-footer-at-break="true" table-omit-header-at-break="false" width="100%" block-progression-dimension="auto" table-layout="fixed" border-style="solid" border-width="0.007in" border-color="#a0a0a0" text-align="left" font-size="9pt" color="#3d3d3d">
                ...
                <fo:table-footer>
                    <fo:table-row font-size="11pt" font-weight="bold" height="30px" line-height="30px"  border-top-width="1px" border-top-color="#a0a0a0">
                        ...
                        <fo:table-cell number-columns-spanned="{$spanned_col}+1" border-style="solid" border-width="0.007in" border-color="#a0a0a0">
                        ...
                        <fo:table-row height="20px" line-height="20px"  background-color="#e5e5e5">
                            ...
                            <xsl:for-each select="*">
                                <fo:table-cell border-style="solid" border-width="0.007in" border-color="#f4f4f4" border-bottom-color="#a0a0a0">
                                    ...
                                    <fo:block margin-left="3px">
                                        <xsl:choose>
                                            <xsl:when test="contains(name(current()) ,'Photo')">
                                                <fo:external-graphic src="file:../../xsl/images/non_img.png" clear="none" float="left" content-height="0.4in" scaling="uniform" border="0" padding="0" margin="0" alignment-baseline="middle"/>
        ...
        <xsl:if test="count(user/ceo) &gt; 0">
            <xsl:call-template name="ceo"></xsl:call-template>
        </xsl:if>
    ...
    <xsl:template name="ceo">
        <fo:block margin-top="2em">
            <fo:table table-layout="fixed" width="100%">
                ...
                <fo:table-body>
                    <fo:table-row>
                        <fo:table-cell line-height="100%">
                            <fo:block color="#5ab8ec" font-weight="bold" font-size="9pt" border-style="solid"  border-width="0.007in" border-color="#5ab8ec">
                                <fo:block margin-top="0.3em" text-align="center">
                                    <fo:block>
                                        USO EXCLUSIVO DOS SERVIÇOS
                                    </fo:block>
                                    <fo:block>
                                        Controlo e registo
                                    </fo:block>
                                </fo:block>
                                <fo:block margin-left="0.5em" margin-top="0.5em">Data:_____/_____/_____</fo:block>
                                <fo:block margin-left="0.5em" margin-top="0.7em" margin-bottom="0.7em">Ass.:</fo:block>
                            </fo:block>
                        </fo:table-cell>
                        <fo:table-cell>
                            <fo:block margin-left="3em"  margin-right="3em" text-align="center" font-size="9pt">
                                <fo:block text-transform="uppercase" font-weight="bold" font-size="12pt">
                                    <xsl:apply-templates select="user/ceo/name"/>
                                </fo:block>
                                <fo:block padding-top="0.3em" margin-top="2.5em" border-top-style="solid" border-top-width="0.007in" border-top-color="black">
                                    (<xsl:apply-templates select="user/ceo/signatureText"/>)
                                </fo:block>                                
                            </fo:block>
                        </fo:table-cell>
                    </fo:table-row>
