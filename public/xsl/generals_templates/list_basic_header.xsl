...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format">
    ...
    <xsl:template name="cover_head">
        ...
        <fo:block text-align="center" text-transform="uppercase" font-size="9pt" font-weight="bold">
            ...
            <fo:block margin-top="0.3em">Seminario Teológico Adventista de Cuba cooperacion cubana</fo:block>
    ...
    <xsl:template name="content_body">
        ...
        <xsl:if test="count(data/element) &gt; 0">
            ...
            <fo:table margin-top="2em" table-omit-footer-at-break="true" table-omit-header-at-break="false" width="100%" block-progression-dimension="auto" table-layout="fixed" border-style="solid" border-width="0.007in" border-color="#a0a0a0" text-align="left" font-size="9pt" color="#3d3d3d">
                ...
                <!--Columnas dinamicas -->
                <xsl:for-each select="header/element[last()]/element">                    
                ...
                <fo:table-header>
                    <fo:table-row font-size="11pt" font-weight="bold" height="20px" line-height="20px"  border-top-width="1px" border-top-color="#a0a0a0">
                        ...
                        <xsl:variable name="spanned_col" select="count(header/element[last()])"/>
                        ...
                        <xsl:if test="position() != last()">
                            <fo:table-row font-size="11pt" background-color="#5ab8ec" height="24px" line-height="24px" font-weight="bold" border-top-width="1px" border-top-color="#a0a0a0" border-bottom-width="1px" border-bottom-color="#fad7a5" alignment-baseline="middle">
                                <xsl:if test="position() = 1">
                                    <xsl:variable name="number_rows" select="count(//header/element)"/>
                                    <fo:table-cell number-rows-spanned="{$number_rows}"  border-style="solid" border-width="0.007in" border-color="#f4f4f4" border-left-color="#a0a0a0" border-top-color="#a0a0a0">
                                        <fo:block margin-left="3px">Nº <xsl:value-of select="$number_rows"></xsl:value-of></fo:block>
                                    </fo:table-cell>
                                </xsl:if>   
                                <xsl:for-each select="element">                                                      
                                    <xsl:variable name="colum-span" select="columns_spanned"/>
                                    <xsl:variable name="row-span" select="rows_spanned"/>
                                    <fo:table-cell number-columns-spanned="{$colum-span}"> 
                                        <xsl:if test="rows_spanned != ''">
                                            <xsl:attribute name="number-rows-spanned"><xsl:value-of select="$row-span"></xsl:value-of></xsl:attribute>
                                        </xsl:if>                       
                                        <fo:block margin-left="3px">
                    ...
                    <fo:table-row font-size="11pt" background-color="#5ab8ec" height="24px" line-height="24px" font-weight="bold" border-top-width="1px" border-top-color="#a0a0a0" border-bottom-width="1px" border-bottom-color="#fad7a5" alignment-baseline="middle">
                        ...
                        <!--Contenido dinamico-->
                        <xsl:variable name="column_count" select="count(header/element[last()])"/>
                        <xsl:for-each select="header/element[last()]/element">
